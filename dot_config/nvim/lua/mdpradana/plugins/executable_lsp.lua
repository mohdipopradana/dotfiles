return {
	...
	config = function()
		...
		-- Change colorscheme for a few diagnostic composition supposed to be much easier to read
		...
		vim.api.nvim_set_hl(0, "DiagnosticSignHint", { fg = colors.white, bg = "none" })
		vim.api.nvim_set_hl(0, "DiagnosticSignInfo", { fg = colors.blue, bg = "none" })
		vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { fg = colors.red, bg = "#103a3c" })
		vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { fg = colors.yellow, bg = "#103a3c" })
		vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { fg = colors.white, bg = "#103a3c" })
		vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { fg = colors.blue, bg = "#103a3c" })
		vim.api.nvim_set_hl(0, "SignColumn", { bg = "none" })

		-- Gruvbox colorscheme
		vim.api.nvim_set_hl(0, "FloatBorder", { fg = colors.bd, bg = "none" })
